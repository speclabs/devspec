...
description: "Use to create or update evidence-backed devspec foundation coding standards."
...
- Organize by language or framework when applicable, then capture cross-cutting standards.
...
3. Check discovery exclusions and exploration state for the same repo, language, or framework.
4. Merge input into a pattern catalog with sections, sources, evidence, confidence, and short examples.
