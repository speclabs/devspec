...
3. Merge the required user input into a stable codebase-structure document, keeping repository layout sections in selective 2-4 level tree-node format with one heading per repo and access requirements for multi-repo configuration.
