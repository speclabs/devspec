...
- Record source evidence, confidence, and specific work guidance for repo configuration, module boundaries, ownership, integrations, and cross-cutting placement rules.
...
- Omit optional boundary tables when the project has no confirmed, observed, inferred, or blocked content for them.
...
## Output Format
- Artifact updated
- Key repo, tree, multi-repo, boundary, confidence, and work-guidance changes
