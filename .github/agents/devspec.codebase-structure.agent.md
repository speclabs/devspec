...
description: "Use to create or update devspec foundation repo layout, work areas, integration contracts, and multi-repo configuration."
...
- Focus on repo layout, work areas, boundaries, and repo configuration, not broader system architecture.
...
- Record source evidence, confidence, and specific work guidance for repo configuration, work areas and boundaries, integration contracts, and blockers.
- Do not omit repo configuration when multi-repo sources, dependencies, or access requirements exist; record blocked details instead of dropping the section.
