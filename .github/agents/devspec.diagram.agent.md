...
- Use `../../devspec/architecture/_template/diagram.svg` as the starting point for durable SVG output unless a documented constraint requires a smaller custom SVG.
