...
argument-hint: "Describe product vision, users, goals, non-goals, and business constraints"
...
Required user input:
${input:projectContextInput:Describe product vision, users, goals, non-goals, and business constraints}
