...
Execution:
- Pass the required work-item reference to `devspec.story`; the agent owns provider resolution, manual fallback, artifact creation, clarification, multi-repo handling, type-specific intake, and handoff behavior.
